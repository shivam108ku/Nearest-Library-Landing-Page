...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(9,9,11,0.85) 0%, rgba(24,24,27,0.95) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(184, 134, 11, 0.5)',
            ...
            <div className="pc-content pc-avatar-content">
              ...
              {showUserInfo && (
                <div className="pc-user-info">
                  ...
                  <a
                    href={contactUrl || `mailto:${email || 'shivam108ku@gmail.com'}`}
                    target="_blank"
